...
public class SearchWeatherController {
    ...
    private static Logger LOGGER = LoggerFactory.getLogger(SearchWeatherController.class);
    ...
    private LocationDTO currentlLocationDTO;
    ...
    public void searchWeatherByLocation() {
        ...
        weatherController.setLatitude(currentlLocationDTO.latitude());
        weatherController.setLongitude(currentlLocationDTO.longitude());
    ...
    public LocationDTO getCurrentlLocationDTO() {
        return currentlLocationDTO;
    }

    public void setCurrentLocationDTO(LocationDTO currentlLocationDTO) {
        this.currentlLocationDTO = currentlLocationDTO;
    }
